...
I want to answer the question: does a teacher's age predict their teacher evaluation rating?

I am going to use the `lm()` function to estimate a linear regression for the variables `age` and `score`. Moreover, I am going to apply the `broom::tidy()` function to get the values for my linear regression equation.
...
It appears that there is a very weak (close to 0) negative relationship between the two variables.

Now, I am going to plot my findings with a line of best fit.
...
I am also curious - does a teacher's age predict their beauty rating?

I am agian going to use the `lm()` function to estimate a linear regression, this time for the variables `age` and `bty_avg`. Moreover, I am going to apply the `broom::tidy()` function to get the values for my linear regression equation.
...
It appears that there is a negative relationship between age and beauty.
